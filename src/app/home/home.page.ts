...
export class HomePage {
  ...
  // httpPost(body: any) {
  //   return this.http.post<any>('http://localhost:3000/payment-sheet', body).pipe(first());
  // }

  httpPost(body: any) {
    return this.http.post<any>('https://j3x0ln9gj7.execute-api.ap-northeast-1.amazonaws.com/dev/' + 'intent', {}).pipe(first());
  }
    ...
    */
    ...
    try {
      ...
      await Stripe.createPaymentSheet({
        ...
        merchantDisplayName: 'Lyon Incode'
      });
